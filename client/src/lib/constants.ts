...
export const musicProjects = [
  ...
  },
  {
    ...
    projectUrl: "https://ai-composer.mit.edu",
    liveDemo: true,
    demoDescription:
    ...
    detailedDescription: `
      This project explores the intersection of artificial intelligence and musical composition, 
      leveraging transformer-based models to generate complex musical arrangements. The system 
      learns from a diverse dataset of classical and contemporary compositions to understand 
      musical structure, harmony, and style.

      The project combines several innovative approaches:
      - Advanced neural network architectures for understanding musical context
      - Real-time MIDI generation and processing
      - Style transfer between different musical genres
      - Interactive parameters for controlling the composition process
    `,
    audioFiles: [
      {
        title: "Classical Style Generation",
        description: "AI-generated piece in the style of classical piano compositions",
        url: "/audio/classical-generation.mp3",
      },
      {
        title: "Jazz Harmony Exploration",
        description: "Complex harmonic progressions generated by the model",
        url: "/audio/jazz-harmony.mp3",
      },
      {
        title: "Multi-instrument Arrangement",
        description: "Full orchestral arrangement generated from a simple melody",
